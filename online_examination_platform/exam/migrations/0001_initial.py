    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_time', models.DateTimeField(default=datetime.datetime(2024, 9, 29, 21, 11, 25, 242177))),
                ('end_time', models.DateTimeField(default=datetime.datetime(2024, 9, 29, 21, 11, 25, 242196))),
                ('professor', models.ForeignKey(limit_choices_to={'groups__name': 'Professor'}, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
